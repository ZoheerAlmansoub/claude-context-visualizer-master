...
> **Agent Session Intelligence** (سابقًا Claude Context Visualizer) — تطبيق ويب محلي لتحليل جلسات وكلاء الذكاء الاصطناعي: فهم استهلاك السياق (tokens)، تجميع رسائل المستخدم، التحليل بالذكاء الاصطناعي، استخراج المهارات والقواعد، واكتشاف المشاكل المتكررة.
